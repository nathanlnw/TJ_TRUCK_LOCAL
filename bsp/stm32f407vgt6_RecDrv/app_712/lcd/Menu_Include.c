...
unsigned char device_version[30]={"主机版本:TRUCK V1.0"};  //{"主机版本:V BD 2.00"};   // 北斗货运平台对接  
unsigned char bd_version[20]={"模块版本:V 17.TJK.01"};
unsigned char bd_version2[20]={"模块版本:V 20.TJK.01"};  
...
u8 Menu_voice_value=0;//存储TTS音量值
ALIGN(RT_ALIGN_SIZE)  
MENUITEM *pMenuItem;   
