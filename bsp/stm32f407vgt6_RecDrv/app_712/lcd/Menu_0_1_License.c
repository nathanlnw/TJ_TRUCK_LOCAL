...
//-----  天地通要求 ----------------
unsigned char Car_HZ_code[31][2]={"宁","陕","甘","京","津","渝","云","辽","黑","湘",\
                                  "皖","鲁","新","苏","浙","赣","鄂","桂","豫","晋",\
                                  "蒙","沪","吉","闽","贵","粤","青","藏","川","冀",\
                                  "琼"};  
