...
typedef struct  _LARGE_LCD
{
   ...
   u16 CounterTimer;  // ¼ÆÊıÆ÷
   u8   Txinfo[300];   //  ¼Ä´æÆ÷ÄÚÈİ
   u16  TxInfolen;    //   ·¢ËÍ ĞÅÏ¢³¤¶È
   u8   TXT_content[256]; 
   u16  TXT_contentLen;
   u8    RxInfo[100];    // ½ÓÊÕÄÚÈİ 
   u16  RxInfolen;     // ½ÓÊÕĞÅÏ¢³¤¶È 
   u8   Type;    //  01  ÊÚÊ± £¬ 02   ËÙ¶È·½Ïò 03 ÎÄ±¾ĞÅÏ¢ 
...
extern u8   Fectch_photo[10];   //----- ±¨¾¯È¡Í¼ÃüÁî  
 ...
 extern u8    _485_CameraData_Enable;// ÓĞÍ¼Æ¬Êı¾İ¹ıÀ´	1: data come  0:   no data 
