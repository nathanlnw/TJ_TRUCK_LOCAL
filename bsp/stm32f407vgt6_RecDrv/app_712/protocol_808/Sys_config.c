...
u8		RemoteIP_main[4]={58,83,210,131};//{125,38,185,88};//{113,31,28,101 };//{113,31,92,200};//天津{60,28,50,210}; 河北天地通 113,31,28,100                        
...
void  Vehicleinfo_Init(void) 
{
	...
	Vechicle_Info.Dev_ProvinceID=12;  // 默认省ID   0      13  河北省
